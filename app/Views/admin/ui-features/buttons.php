    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        >
          ...
          /></a>
          <a
            class="sidebar-brand brand-logo-mini pl-4 pt-3"
            href=""
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                      <p class="mb-0">
                        James
                        <span class="text-small text-muted"
                          >posted a photo on your wall</span
                        >
                      </p>
                    </div>
                  </a>
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                      <p class="mb-0">
                        Alex
                        <span class="text-small text-muted"
                          >just mentioned you in his post</span
                        >
                      </p>
                    </div>
                  </a>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">
                      Use any of the available button classes to quickly create
                      a styled button.
                    </p>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="template-demo">
                      ...
                      >
                        Block buttons <i class="mdi mdi-menu float-right"></i>
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        <i class="mdi mdi-account"></i> Block buttons
                      </button>
                      <button
                        type="button"
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="template-demo mt-4">
                          ...
                          >
                            ...
                            >
                              <i
                                class="mdi mdi-format-vertical-align-center"
                              ></i>
                            </button>
                            <button
                              type="button"
                        ...
                        <div class="template-demo mt-4">
                          ...
                          >
                            ...
                            <button
                              ...
                              class="btn btn-outline-secondary"
                            >
                              <i class="mdi mdi-reload d-block mb-1"></i> Reload
                            </button>
                            <button
                              type="button"
                              class="btn btn-outline-secondary"
                            >
                              <i class="mdi mdi-account d-block mb-1"></i> Users
                            </button>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="template-demo mt-2">
                          <button class="btn btn-dark btn-icon-text">
                            <i
                              class="mdi mdi-apple btn-icon-prepend mdi-36px"
                            ></i>
                          ...
                          <button class="btn btn-dark btn-icon-text">
                            <i
                              class="mdi mdi-android-debug-bridge btn-icon-prepend mdi-36px"
                            ></i>
                            <span class="d-inline-block text-left">
                              <small class="font-weight-light d-block"
                                >Get it on the</small
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="template-demo">
                      ...
                      <button
                        type="button"
                        class="btn btn-social-icon btn-dribbble"
                      >
                        <i class="mdi mdi-dribbble"></i>
                      </button>
                      <button
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="template-demo">
                      ...
                      <button
                        type="button"
                        class="btn btn-social-icon-text btn-google"
                      >
